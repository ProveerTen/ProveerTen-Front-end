...
export class ViewProfileComponent {
  ...
  onSubmitSocialRed() {
    ...
    this.client.postRequest(`${environment.url_logic}/edit_profile/socialRed`, data, undefined, { "Authorization": `Bearer: ${this.auth.getToken()}` }).subscribe({
      next: (response: any) => {
        console.log(response);
        this.addSocialRed()
      },
  ...
  getSocialReds() {
    ...
    this.client.getRequest(`${environment.url_logic}/edit_profile/socialRed`, undefined, { "Authorization": `Bearer ${this.auth.getToken()}` }).subscribe({
      next: (response: any) => {
