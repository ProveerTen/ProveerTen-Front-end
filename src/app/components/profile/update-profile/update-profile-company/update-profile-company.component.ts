...
export class UpdateProfileCompanyComponent {
  ...
  constructor(private client: ClientService, public auth: AuthService, private fb: FormBuilder, private router: Router) {
    ...
    this.form = this.fb.group({
      nit_company: [''],
      name_company: ['', [Validators.required, Validators.minLength(3), Validators.maxLength(7)]], //1-100
      ...
      foundation_company: ['', [Validators.minLength(1), Validators.maxLength(40)]],
      description_company: ['', [Validators.minLength(1), Validators.maxLength(255)]]
    })
  }
